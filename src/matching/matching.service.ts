...
아래 JSON으로만 답해. 다른 말 붙이지 마
{
  "reasons": [
    {
      "summary": "이 공고를 추천하는 핵심 이유 (2문장, 존댓말, 한글 공백 포함 200자 이상)",
      "matches": ["겹치는 지점을 구체적으로 설명 (무엇↔무엇이 맞고, 그게 왜 의미 있는지까지, 한글 공백 포함 200자 이상)"],
      "confirm": ["확인하거나 보완하면 좋을 점과, 그 이유 (한글 공백 포함 200자 이상)"]
    }
  ]
}
- reasons 배열의 길이는 입력으로 주어진 공고 개수와 정확히 같아야 하고, 순서도 같아야 해
- 각 공고의 matches는 3개, confirm은 2개
